...
// bits.
pub const EXPANSION_FUNCTION: [u8; 48] = [
...
pub const PERMUTATION_FUNCTION: [u8; 32] = [
...
// from a 64-bit input.
pub const PERMUTED_CHOICE1: [u8; 56] = [
...
// the 56-bit input
pub const PERMUTED_CHOICE2: [u8; 48] = [
...
pub const KS_ROTATIONS: [u8; 16] = [1, 1, 2, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2, 2, 1];
