 ...
 *
 * TypeScript port of OpenSSL crypto/aes/asm/vpaes-x86_64.pl.
 * Copyright 2009-2026 The OpenSSL Project Authors. All Rights Reserved.
 * Licensed under Apache License 2.0.
 *
 * Pinned to the reference configuration: $win64=0.
 */
