/**
 * AES (T-table) for x86_64.
 *
 * TypeScript port of OpenSSL crypto/aes/asm/aes-x86_64.pl.
 * Copyright 2002-2025 The OpenSSL Project Authors. All Rights Reserved.
 * Licensed under Apache License 2.0.
 *
 * Pinned to the reference configuration: $win64=0 (unix SysV argument
 * registers; the Win64 SEH handlers are omitted). Exports AES_encrypt,
 * AES_decrypt, AES_set_encrypt_key, AES_set_decrypt_key, AES_cbc_encrypt
 * and their asm_* aliases.
 *
 * Register map (from the perl):
 *   s0=%eax s1=%ebx s2=%ecx s3=%edx
 *   acc0/mask80=%esi acc1/maskfe=%edi acc2/mask1b=%ebp
 *   inp=%r8 out=%r9 t0=%r10d t1=%r11d t2=%r12d rnds=%r13d
 *   sbox=%r14 key=%r15
 */
